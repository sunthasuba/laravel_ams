...
class ExamController extends Controller
{
    ...
    {
        $this->middleware('sessionincharge');
    }
    /**
    ...
    public function index()
    {
        ...
        return view('sessionincharge.exams.index', compact('exams', 'course', 'halls'));
        // return $exams;
    }
    ...
    public function inputExam($id)
    {
        ...
        $student_exams = DB::table('student_exams')
            ...
            ->get();
        return view('sessionincharge.exams.inputExam', compact('course', 'id','student_exams'));
    }
}
