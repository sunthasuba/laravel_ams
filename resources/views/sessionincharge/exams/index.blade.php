                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="ExamAddModalLabel">Attendance Info</h5>
                                        </div>
                                        <div class="modal-body">
                                            <form>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-md-10 m-auto">
                                                        <small class="fs-6 text-muted">Day of Attendance</small>
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetch() {
                $.ajax({
                    type: "GET",
                    url: "/sessionincharge/exams/getExams",
                    dataType: "json",
            ...
            $(document).on('click', '.addExam', function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/sessionincharge/exams/store",
                    data: data,
                    dataType: "json",
                    success: function(response) {
            ...
            $(document).on('click', '.exam-edit', function(e) {
                ...
                $.ajax({
                    type: "GET",
                    url: `/sessionincharge/exams/edit/${examId}`,
                    dataType: "json",
                    success: function(response) {
            ...
            $(document).on('click', '.updateExam', function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/sessionincharge/exams/update",
                    data: data,
                    dataType: "json",
                    success: function(response) {
                        $('.course_id').removeClass('is-invalid');
            ...
            $(document).on('click', '.exam-delete', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: "GET",
                            url: `/sessionincharge/exams/destroy/${examId}`,
                            dataType: "json",
                            success: function(response) {
                                fetch();
                                if (response.status == true) {
            ...
            $(document).on('click', '.exam-input', function(e) {
                ...
                var examId = $(this).val();
                // console.log(examId);
                window.location.href = `/sessionincharge/exams/inputExam/${examId}`;
            });
        });
    </script>
@endsection
