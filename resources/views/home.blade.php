...
<div class="container">
                ...
                <div class="card border-0 shadow-lg">
                    <div class="card-header border-0 bg-transparent mb-2 fs-2 text-primary lead">
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="col-5">
                                <input type="search" id="searchUsers" class="form-control shadow-none rounded-0"
                                    placeholder="Type anything to search">
                            </div>

                            <div class="col-3">
                            <a href="{{ route('pdf') }}" class="btn btn-success rounded-0 shadow-none">
        <i class="fa-solid fa-file-excel"></i> Export Users
    </a>
                            </div>
                        </div>
                    </div>
    ...
    @endif
    @if (Auth::user()->role == 'Sessionincharge')
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card border-0 shadow-lg">
                    <div class="card-header border-0 bg-transparent mb-2 fs-2 text-primary lead">
                        <div class="d-flex justify-content-between">
                            <span>{{ __('Student Report Table') }}</span>
                            <div class="col-5">
                                <input type="search" id="searchExamsStudent" class="form-control shadow-none rounded-0"
                                    placeholder="Type anything to search">
                            </div>
                            <div class="col-3">
...
@section('scripts')
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/TableToExcel/1.2/tableToExcel.min.js"></script>
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.excelExamsStudent', function(e) {
                console.log('Excel button clicked for Exams Student');
                e.preventDefault(e);
            ...
            $(document).on('click', '.excelUsers', function(e) {
                console.log('Excel button clicked for Users');
                e.preventDefault(e);
                const start = Date now();
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function fetch() {
                $.ajax({
                    type: "GET",
                    url: "/sessionincharge/studentExam/getStudentExam",
                    dataType: "json",
